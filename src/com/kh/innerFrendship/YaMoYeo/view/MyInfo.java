...
//		saveBtn.setLocation(540, 20);
		...
		pwCorrect.setLocation(28, 210);
		
		JTextField pwtf2 = new JTextField("비밀번호를 한번 더 입력해주세요");
		...
		nameIcon.setLocation(30, 270);
		
		JTextField nametf = new JTextField("성함을 입력해 주세요");
		...
		emailIcon.setLocation(32, 328);
		
		JTextField emailtf = new JTextField("사용하실 E-mail 주소를 입력해주세요");
